...
bedtools intersect -wa -u -f $OVERLAP  -b Contactdomainsasbedfile.bed -a tmp.bed|sort -u  | wc -l >> $1.rnd
bedtools intersect -wa -u -f $OVERLAP  -b Contactdomainsasbedfile.bed -a tmp2.bed|sort -u  | wc -l >> $2.rnd

bedtools intersect -wa -u -f $OVERLAP  -b Contactdomainsasbedfile.bed -a tmp-r.bed|sort -u  | wc -l >> $1.srnd
bedtools intersect -wa -u -f $OVERLAP  -b Contactdomainsasbedfile.bed -a tmp2-r.bed|sort -u  | wc -l >> $2.srnd
done 
